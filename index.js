...
function addAddress() {
  ...
  if (address) document.getElementById("add-address").innerText = address;
  else alert("Address not added");
}
...
function displayItems() {
  ...
  var paneer = document.getElementById("chicken");
  var chicken = document.getElementById("paneer");
